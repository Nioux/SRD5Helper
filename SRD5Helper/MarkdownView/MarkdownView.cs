            ...
            switch (inline)
            {
                ...
                case LinkInline link:
                    ...
                    if(link.IsImage)
                    {
                        ...
                        // TODO : gérer les icones/fonts comme images inline, en utilisant des Label / FontFamily
                        // et un format d'uri style mafont.ttf?char=124&color=ff00dd&size=23
                        // => permettra d'avoir des icones pour Avantage/Désavantage, etc...
                        if (Uri.TryCreate(url, new UriCreationOptions(), out Uri uri))
                        {
                            ...
                            if(scheme == "fonts")
                            {
                                ...
                                return new[]
                                {
                                    ...
                                    {
                                        //Text="\u2002",
                                        Text = query.Get("text"), // uri.Query, // "\uf059",
                                        FontSize = double.Parse(query.Get("size")),
                                        FontFamily = uri.LocalPath, // this.Theme.Code.FontFamily,
                                        TextColor = Color.FromArgb(query.Get("color")), // ?? this.Theme.Code.ForegroundColor,
                        ...
                        {
                            // /MauiApp3;component/Resources/Images/... ImageSource.FromUri ?
                            image.Source = url.TrimStart('/'); //Assembly.GetExecutingAssembly()
                        }*/
                ...
                case CodeInline code:
                    return new[]
                    {
                        new Span()
                        {
                            ...
                            TextColor = this.Theme.Code.ForegroundColor,
                            BackgroundColor = this.Theme.Code.BackgroundColor
                        },
                        new Span
                        {
